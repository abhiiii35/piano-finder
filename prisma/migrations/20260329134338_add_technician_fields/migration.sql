...
INSERT INTO "new_TechnicianProfile" ("addressLine1", "bio", "businessName", "certifications", "city", "createdAt", "id", "isActive", "isVerified", "latitude", "longitude", "serviceRadius", "state", "stripeAccountId", "updatedAt", "userId", "yearsExperience", "zipCode") SELECT "addressLine1", "bio", "businessName", "certifications", "city", "createdAt", "id", "isActive", "isVerified", "latitude", "longitude", "serviceRadius", "state", "stripeAccountId", "updatedAt", "userId", "yearsExperience", "zipCode" FROM "TechnicianProfile";
